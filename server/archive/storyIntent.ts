...
function buildIntentPrompt(params: {
  ...
  return [
    ...
    "- brand_promo：品牌、产品、项目宣传",
    "- pitch：路演、融资、提案、对客户/投资人说明",
    ...
    "{",
    '  "purpose": "personal_memory | social_post | linkedin_job_search | portfolio | gift | relationship_record | brand_promo | pitch | creative_expression | exploration",',
