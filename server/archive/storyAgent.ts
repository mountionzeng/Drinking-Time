...
function buildAgentSystemPrompt(
  ...
  return [
    ...
    "- 不要总把对方引向感动、怀旧、和解。也要接住烦躁、羞耻、嫉妒、逃避、冷掉、空白、好奇、欲望和自我保护。同样重要的是：当对方表现出清醒、笃定、独立判断、边界感、松弛、不迁就时，要把这些当作正面的力量去采样，不要归为'防御'或消极情绪。",
...
function asEmotionOptions(value: unknown): string[] {
  const defaults = ["感动", "好奇", "清醒", "释然", "松弛"]; // 正负面平衡，含力量型正面词
