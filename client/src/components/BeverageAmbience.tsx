      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: `oklch(0.75 0.14 80 / ${0.15 + Math.random() * 0.25})`,
          }}
          animate={{
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: `oklch(0.62 0.12 155 / ${0.04 + Math.random() * 0.08})`,
            filter: 'blur(8px)',
          }}
          animate={{
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: `oklch(0.85 0.04 80 / ${0.03 + Math.random() * 0.06})`,
            borderRadius: '50%',
            filter: 'blur(6px)',
      ...
      {Array.from({ length: 4 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: `radial-gradient(circle, oklch(0.58 0.16 30 / ${0.04 + Math.random() * 0.06}) 0%, transparent 70%)`,
      ...
      {Array.from({ length: 10 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            left: `${10 + Math.random() * 80}%`,
            top: `${10 + Math.random() * 80}%`,
            background: `oklch(0.52 0.08 55 / ${0.1 + Math.random() * 0.15})`,
          }}
          animate={{
            rotate: [0, 360],
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div
            ...
            style={{ backgroundImage: `url(${BG_IMAGES[element]})`, opacity: 0.18 }}
          />
          <div
            className="absolute inset-0"
            style={{
              background: 'linear-gradient(180deg, oklch(0.975 0.008 75 / 82%) 0%, oklch(0.975 0.008 75 / 90%) 50%, oklch(0.975 0.008 75 / 96%) 100%)',
            }}
          />
          {/* Particles */}
          <Particles />
