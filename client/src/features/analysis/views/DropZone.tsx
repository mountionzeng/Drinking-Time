...
export default function DropZone({ projectId, onAnalysisComplete, onRunAnalysis, isAnalyzing, onUploadFile, onRefreshRefs }: DropZoneProps) {
  ...
  const processFiles = useCallback(async (files: File[]) => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : '请重试';
    ...
    setState('done');
    onRefreshRefs(projectId);
    onAnalysisComplete();
  }, [projectId, onUploadFile, onRefreshRefs, onRunAnalysis, onAnalysisComplete]);
