...
describe("previewSubtitleLines", () => {
  ...
  it("falls back to a clearly-labelled read-only candidate only when the formal slice is absent", () => {
    expect(
      previewSubtitleLines({
        subtitlePlan: null,
  ...
  it("keeps an intentionally empty formal subtitle slice empty", () => {
    expect(
      previewSubtitleLines({
