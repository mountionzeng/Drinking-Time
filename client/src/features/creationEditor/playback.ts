import {
  MAX_STORY_SHOT_DURATION_MS,
  MIN_STORY_SHOT_DURATION_MS,
} from "@shared/storyContract";

export const MIN_SHOT_DURATION_MS = MIN_STORY_SHOT_DURATION_MS;
export const MAX_SHOT_DURATION_MS = MAX_STORY_SHOT_DURATION_MS;
