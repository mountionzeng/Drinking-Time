...
import type { VisualThemeMode } from "./visualTheme";
...
const SHIGUANG_FAVICON = "/shiguang/mobile-avatar.png";
...
export function setThemeFavicon(
  element: NayinElement,
  visualTheme: VisualThemeMode
): void {
  const favicon = faviconForTheme(element, visualTheme);
