...
账号页可生成五分钟有效、只能使用一次的电脑登录码；在网页登录页切到“微信登录”并输入后，会进入同一个账号的云端故事库。邮箱注册、两个已有内容账号合并仍未完成；每日来信自动迎面、气息/相关故事布局和生日滚轮仍与新版手机版有差异。真机配对、键盘、安全区和跨端视频生成尚待验证，不能宣称100%还原或正式发布。
